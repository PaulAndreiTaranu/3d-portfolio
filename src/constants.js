...
export const calculateSizes = (isSmall, isMobile, isTablet) => {
    return {
        ...
        cubePosition: isMobile ? [4, -5, 5] : isTablet ? [5, -5, 5] : [5, -5.5, 5],
        reactLogoPosition: isMobile ? [4, 2, 0] : isTablet ? [5, 2, 0] : [7, 2, 0],
        ringPosition: isMobile ? [-10, 5, 6] : isTablet ? [-13, 0, 6] : [-15, 0, 6],
        targetPosition: isMobile ? [-9, -10, -10] : isTablet ? [-11, -7, -10] : [-13, -13, -10],
    }
}
